...
//
// On Sat Sep 24 01:39:12 IST 2011
//
...
module mkClock(CLK,
  ...
  reg [16 : 0] decelerator;
  wire [16 : 0] decelerator$D_IN;
  wire decelerator$EN;
  ...
  // inputs to muxes for submodule ports
  assign MUX_hrs$write_1__VAL_2 = (hrs == 5'd23) ? 5'd0 : x__h390 ;
  assign MUX_min$write_1__VAL_2 = (min == 6'd59) ? 6'd0 : x__h358 ;
  assign MUX_sec$write_1__VAL_2 = (sec == 6'd59) ? 6'd0 : x__h319 ;

  // register decelerator
  assign decelerator$D_IN = decelerator + 17'd1 ;
  assign decelerator$EN = running ;

  // register hrs
  assign hrs$D_IN = EN_setHH ? setHH_hh : MUX_hrs$write_1__VAL_2 ;
  assign hrs$EN =
	     decelerator == 17'd0 && sec == 6'd59 && min == 6'd59 ||
	     EN_setHH ;

  // register min
  assign min$D_IN = EN_setMM ? setMM_mm : MUX_min$write_1__VAL_2 ;
  assign min$EN = decelerator == 17'd0 && sec == 6'd59 || EN_setMM ;
  ...
  assign sec$EN = EN_setSS || decelerator == 17'd0 ;

  // remaining internal signals
  assign x__h319 = sec + 6'd1 ;
  assign x__h358 = min + 6'd1 ;
  assign x__h390 = hrs + 5'd1 ;
  ...
  begin
    if (!RST_N)
      begin
        decelerator <= `BSV_ASSIGNMENT_DELAY 17'd0;
