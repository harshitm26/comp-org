...
module mkMukhya(CLK,
  ...
  wire RDY_retAnodeSelected, RDY_retSegmentData;
  ...
  // ports of submodule switchInput
  wire [1 : 0] switchInput$retInSel;
  ...
  // submodule switchInput
  mkInSel switchInput(.CLK(CLK),
		      .RST_N(RST_N),
		      .retInSel(switchInput$retInSel),
		      .RDY_retInSel());
  ...
  // register segmentData
  always@(switchInput$retInSel or
	  displaySelected or
	  h2s12$decode or
